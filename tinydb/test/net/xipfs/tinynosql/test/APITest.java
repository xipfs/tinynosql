package net.xipfs.tinynosql.test;
...
import net.xipfs.tinynosql.core.Application;
import net.xipfs.tinynosql.core.NoSQLInterface;
import net.xipfs.tinynosql.core.Table;
